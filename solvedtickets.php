...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
           ...
           <li style= "background-color: #594f8d;"><a href="solvedtickets.php" style= " text-decoration: none;"><i class="fas fa-check"></i>My Tickets</a></li>
   ...
   <h1 class="text-primary text-center mt-4 mb-3" >My Tickets</h1>

<?php
$que = "SELECT * FROM tickets where username = '{$_SESSION['username']}' ";
...
<li class="list-group-item"> <strong class="text-primary mr-4">Status of issue:</strong> <span class="text-danger">'.$row['status'].'  </span> </li>
<li class="list-group-item">  <strong class="text-primary mr-1">Admin Replay:</strong> <span class="text-danger">'.$row['replay'].'  </span> </li>
