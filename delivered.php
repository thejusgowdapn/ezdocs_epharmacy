...
<!-- <header>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li style= "background-color: #594f8d;"><a href="delivered.php" style= " text-decoration: none;"><i class="fas fa-truck"></i>Delivired orders</a></li>
    ...
    <h1 class="text-primary text-center mt-4 mb-3" >Delivered orders</h1>
