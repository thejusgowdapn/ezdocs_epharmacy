...
$sql = "UPDATE tickets SET status = '$status', replay = '$text' where username = '$username' AND id = '$id' ";
...
<!-- <header>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li style= "background-color: #594f8d;"><a href="admintickets.php" style= " text-decoration: none;"> <i class="fas fa-ticket-alt"></i>Tickets</a></li>
    ...
    <h1 class="text-primary text-center mt-4 mb-3" >All Tickets</h1>
...
<!-- mesg end -->
  ...
  <li class="list-group-item">  <strong class="text-primary mr-3">Date:</strong> '.$row['date'].'  </li>
    <li class="list-group-item">  <strong class="text-primary mr-3">subject:</strong> '.$row['subject'].'  </li>
    <li class="list-group-item"> <strong class="text-primary mr-1">Issue Type:</strong> '.$row['type'].' </li>
    <li class="list-group-item"> <strong class="text-primary mr-1">current status:</strong><span class="text-danger"> '.$row['status'].'</span> </li>
    <li class="list-group-item"> <strong class="text-primary mr-1">Issue Description:</strong> <span class="text-danger"> '.$row['description'].' </status></li>

    
    <li class="list-group-item">  <strong class="text-primary mr-1">Update Status:</strong>  
    ...
    <li class="list-group-item">  <strong class="text-primary mr-1">Replay:</strong>
